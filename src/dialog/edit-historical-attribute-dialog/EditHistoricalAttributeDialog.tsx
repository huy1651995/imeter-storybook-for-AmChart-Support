...
import * as equipmentMockData from '../../mock-data/equipment';
import { parseEquipmentList } from '../../transfer/equipment-tabs/functions';
import { EquipmentData } from '../../transfer/equipment-tabs/types';
...
const ConfirmationDialog: React.FC<{ open: boolean; onClose: () => void; onConfirm: () => void }> =
...
const EditHistoricalAttributeDialog: React.FunctionComponent<EditHistoricalAttributeDialogProps> =

...
/* harmony import */ var _amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @amcharts/amcharts5/xy */ "./node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/ValueAxis.js");
/* harmony import */ var _amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @amcharts/amcharts5/xy */ "./node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/AxisRendererY.js");
...
/* harmony import */ var _amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @amcharts/amcharts5/xy */ "./node_modules/@amcharts/amcharts5/.internal/charts/xy/series/SmoothedXLineSeries.js");
...
const useLineChart = (chartDiv, chartData, streamColors, legendGrayList, legendPanelOpen, connectedWells, labels, excludeLabel, reasons, labeling, frequency, scope, zoom, yAxisMinMax, hasMouseEvents) => {
  /* eslint-disable */console.log(...oo_oo(`d20995cf_0`, '🚀 ~ file: useLineChart.ts:52 ~ chartData:', chartData));
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect)(() => {
    ...
    const yAxis = chart.yAxes.push(_amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_11__.ValueAxis["new"](root, {
      renderer: _amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_12__.AxisRendererY["new"](root, {})
    }));
    const rightYAxis = chart.yAxes.push(_amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_11__.ValueAxis["new"](root, {
      renderer: _amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_12__.AxisRendererY["new"](root, {
        opposite: true
      })
    }));
    const cursor = chart.set('cursor', _amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_13__.XYCursor["new"](root, {
      behavior: 'zoomX'
    }));
    ...
    if (chartData.length > 0 && streamColors.length && yAxisMinMax) {
      ...
      chartData.forEach(({
        ...
        const axisSeries = chart.series.push(_amcharts_amcharts5_xy__WEBPACK_IMPORTED_MODULE_14__.SmoothedXLineSeries["new"](root, {
          name: displayName,
          valueXField: 'date',
          valueYField: 'value',
          xAxis,
...
//# sourceMappingURL=charts-MassExcludedChart-MassExludedChart-stories.af9db94b792f90ccdd69.hot-update.js.map
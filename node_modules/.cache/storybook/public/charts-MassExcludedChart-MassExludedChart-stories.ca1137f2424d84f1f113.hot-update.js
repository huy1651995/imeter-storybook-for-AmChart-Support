...
const useLineChart = (chartDiv, chartData, streamColors, legendGrayList, legendPanelOpen, connectedWells, labels, excludeLabel, reasons, labeling, frequency, scope, zoom, yAxisMinMax, hasMouseEvents) => {
  /* eslint-disable */console.log(...oo_oo(`db783064_0`, '🚀 ~ file: useLineChart.ts:52 ~ chartData:', chartData));
  ...
  // useLayoutEffect(() => {
  //    if (chartData.length > 0 && streamColors.length && yAxisMinMax) {
  //       const chart = chartRef.current as amLine.XYChart;
  //       const { root } = chart;
  //       const xAxis = chart.xAxes.getIndex(0) as amLine.DateAxis<amLine.AxisRendererX>;
  //       const yAxis = chart.yAxes.getIndex(0) as amLine.ValueAxis<amLine.AxisRendererY>;
  //       const rightYAxis = chart.yAxes.getIndex(1) as amLine.ValueAxis<amLine.AxisRendererY>;
...
//# sourceMappingURL=charts-MassExcludedChart-MassExludedChart-stories.ca1137f2424d84f1f113.hot-update.js.map